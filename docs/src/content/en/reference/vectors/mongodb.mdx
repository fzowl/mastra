...
### Vector embeddings with VoyageAI by MongoDB

VoyageAI by MongoDB provides specialized embedding models optimized for retrieval tasks. VoyageAI is also integrated with MongoDB Atlas for multimodal embeddings.
