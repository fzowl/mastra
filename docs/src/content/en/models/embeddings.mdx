...
- `voyage-4-nano` - 1024 dimensions (default), supports 256-2048 dimensions, smallest open-weight model
- `voyage-code-4` - 1024 dimensions (default), supports 256-2048 dimensions, latest model optimized for code retrieval
