...
- `voyage-4-nano` - 1024 dimensions (default), supports 256-2048 dimensions, smallest open-weight model (1M max tokens per batch)
- `voyage-code-4` - 1024 dimensions (default), supports 256-2048 dimensions, latest model optimized for code retrieval (120k max tokens per batch)
- `voyage-code-3` - 1024 dimensions (default), supports 256-2048 dimensions, optimized for code retrieval (previous generation)
